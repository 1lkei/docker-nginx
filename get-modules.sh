...
mkdir new-headers-more-nginx-module #http-flv-module
# echo "https://github.com/winshining/nginx-http-flv-module/archive/v1.2.11.tar.gz" > http-flv-module/source
echo "https://github.com/openresty/headers-more-nginx-module/archive/v0.35.tar.gz" > new-headers-more-nginx-module/source